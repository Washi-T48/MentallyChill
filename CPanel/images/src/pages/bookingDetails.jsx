...
//                   <div>11:27 AM</div>
//                 </div>
//                 <div className="text-2xl font-medium mb-4 w-1/2">Topic : Topic 2</div>
...
//                         Hello Worldlenmgeioklgbeuigio;ehngiosdsdasdasdasdsdfnelgkeogl'eogmeogjmoegeormgoeasdasddledmgoemnogegioeigjeigbniwlkmfwmfok
//                     </div>
//                   </div>
...
//                     </div>
//                     <div className="flex w-full h-60 bg-gray-100 break-all p-2">
//                         Hello Worldlenmgeioklgbeuigio;ehngiosdsdasdasdasdsdfnelgkeogl'eogmeogjmoegeormgoe
//                     </div>
//                   </div>
//                   <div className="w-full">
//                     <div className="text-2xl font-medium mb-4">
...
//                 <div className="text-2xl font-medium">หมายเลขโทรศัพท์ติดต่อ : xxxxxxxxxx</div>
//                 <div className="flex flex-row justify-between gap-4">
//                   <button className="bg-[#24DB36] rounded-full px-10 py-2" onClick={() => handleClick('Feedback')}>Accept</button>
//                   <button className="bg-[#FF0000] rounded-full px-10 py-2" onClick={() => handleClick('Declined')}>Decline</button>
//                 </div>
//                 </div>
//               </div>
//             </div>
    ...
    <>
      <div className="flex flex-col flex-1 h-dvh">
        ...
        <div className="flex flex-row flex-1">
          ...
          <Content handleClick={handleClick} reasonNote={reasonNote} setReasonNote={setReasonNote} />
        </div>
      </div>
    </>
  );
