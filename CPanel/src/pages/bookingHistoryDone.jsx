          ...
          <div className="p-4 flex flex-col justify-between h-full">
            <div>
              ...
              <div className="flex flex-row gap-3 mb-4">
                ...
                <div className="flex w-full h-60 bg-gray-100 break-all p-2 mb-2">IDNEUIFNDNFNI</div>
                  <div className="text-2xl font-medium mb-4">
                    Conclusion
                  </div>
                  <div className="flex w-full h-16 bg-gray-100 break-all p-2">sedfsferfn</div>
                </div>
                <div className="flex w-full justify-end">
                  <div className="flex w-full h-full bg-gray-100 break-all p-2">sdfsfniehrf89hw</div>
                </div>
              </div>
            </div>
            <div className="flex flex-row justify-end border-t-4 border-[#FFFFFF] pt-3">
              <div className="flex flex-row justify-between gap-4">
                <button className="bg-[#FF0000] rounded-full px-10 py-2" onClick={() => handleClick('Cancel')}>Back</button>
              </div>
              </div>
            </div>
          </div>
