...
export default function EditProfilePage() {
    ...
    const handleRegister = async (data) => {
        try {
            ...
            setErrorMessage('');
            setSuccessMessage('');
            const response = await axios.post('/auth/updateStaff', data, { withCredentials: true });
            setLoading(false);
            if (response.status === 200 || response.status === 201) {
                ...
                setErrorMessage('การแก้ไขบัญชีเจ้าหน้าที่ไม่สำเร็จ กรุณาลองอีกครั้ง');
            }
        } catch (error) {
            setLoading(false);
        ...
        <div className="flex flex-col flex-1 h-dvh">
            ...
            <div className="flex flex-col md:flex-row flex-1">
                ...
                <div className="flex flex-col flex-1 m-5 md:m-10 relative">
                    <div className="text-2xl md:text-5xl mb-6 md:mb-10">แก้ไขบัญชีเจ้าหน้าที่</div>
