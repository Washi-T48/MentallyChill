    ...
    <div>
      ...
      <div className='p1_dass21-content'>
        ...
        <form className='dass21-1'>
          ...
          <Radio_rate questionNumber={1} selectedValue={selectedValues[1]} onRadioChange={handleRadioChange} />
          <br/><label>2.ฉันรู้ตัวว่าปากแห้ง (a)</label>
          <Radio_rate questionNumber={2} selectedValue={selectedValues[2]} onRadioChange={handleRadioChange} />
          <br/><label>3.ฉันดูเหมือนจะไม่มีความรู้สึกดีๆ เลย (d) </label>
          <Radio_rate questionNumber={3} selectedValue={selectedValues[3]} onRadioChange={handleRadioChange} />
          <br/><label>4.ฉันมีอาการหายใจลำบาก (เช่น หายใจเร็วเกินไป หายใจไม่ออก ในกรณีที่ไม่ได้ออกกําลังกาย) (a) </label>
          <Radio_rate questionNumber={4} selectedValue={selectedValues[4]} onRadioChange={handleRadioChange} />
          <br/><label>5.ฉันพบว่ามันยากที่จะคิดริเริ่มที่จะทำสิ่งต่าง ๆ (d)</label>
          <Radio_rate questionNumber={5} selectedValue={selectedValues[5]} onRadioChange={handleRadioChange} />
          <br/><label>6.ฉันมักจะตอบสนองต่อสถานการณ์มากเกินไป (s) </label>
          <Radio_rate questionNumber={6} selectedValue={selectedValues[6]} onRadioChange={handleRadioChange} />
          <br/><label>7.ฉันมีอาการสั่น (เช่น มือสั่น) (a) </label>
          <Radio_rate questionNumber={7} selectedValue={selectedValues[7]} onRadioChange={handleRadioChange} />
        </form>
